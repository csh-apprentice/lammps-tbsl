...
#SBATCH --job-name=sl_1e6_01_10_alpha_0_5_noio
#SBATCH --output=run_1e6_01_10_alpha_0_5_noio.lammps
#SBATCH --error=run_1e6_01_10_alpha_0_5_noio.err
...
mpirun -np ${SLURM_NTASKS} ./lmp -in in.simulation_1e6_alpha_0_5_noio