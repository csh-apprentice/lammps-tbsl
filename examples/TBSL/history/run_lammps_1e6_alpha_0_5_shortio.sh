...
#SBATCH --job-name=sl_1e6_01_13_alpha_0_5_shortio
#SBATCH --output=run_1e6_01_13_alpha_0_5_shortio.lammps
#SBATCH --error=run_1e6_01_13_alpha_0_5_shortio.err
...
mpirun -np ${SLURM_NTASKS} ./lmp -in in.simulation_1e6_alpha_0_5_shortio