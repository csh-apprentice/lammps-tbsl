...
#SBATCH --job-name=sl_1e6_01_09_alpha_1_restart
#SBATCH --output=run_1e6_01_09_alpha_1_restart.lammps
#SBATCH --error=run_1e6_01_09_alpha_1_restart.err
...
mpirun -np ${SLURM_NTASKS} ./lmp -in in.simulation_1e6_alpha_1_restart