...
#SBATCH --job-name=sl_1e6_01_08_alpha_0_5
#SBATCH --output=run_1e6_01_08_alpha_0_5.lammps
#SBATCH --error=run_1e6_01_08_alpha_0_5.err
...
mpirun -np ${SLURM_NTASKS} ./lmp -in in.simulation_1e6_alpha_0_5