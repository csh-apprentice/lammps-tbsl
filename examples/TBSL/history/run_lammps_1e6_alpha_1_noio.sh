...
#SBATCH --job-name=sl_1e6_01_10_alpha_1_noio
#SBATCH --output=run_1e6_01_10_alpha_1_noio.lammps
#SBATCH --error=run_1e6_01_10_alpha_1_noio.err
...
mpirun -np ${SLURM_NTASKS} ./lmp -in in.simulation_1e6_alpha_1_noio