...
#SBATCH --job-name=sl_1e6_01_13_alpha_1_shortio
#SBATCH --output=run_1e6_01_13_alpha_1_shortio.lammps
#SBATCH --error=run_1e6_01_13_alpha_1_shortio.err
...
mpirun -np ${SLURM_NTASKS} ./lmp -in in.simulation_1e6_alpha_1_shortio