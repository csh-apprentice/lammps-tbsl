...
#ifdef READER_CLASS
// clang-format off
ReaderStyle(native,ReaderSLNative);
// clang-format on
#else

#ifndef LMP_READER_SLNATIVE_H
#define LMP_READER_SLNATIVE_H
...
class ReaderSLNative : public Reader {
 public:
  ReaderSLNative(class LAMMPS *);
  ~ReaderSLNative() override;
