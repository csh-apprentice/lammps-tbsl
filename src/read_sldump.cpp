...
void ReadSLDump::command(int narg, char **arg)
{
  ...
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"READSLDUMP DEBUG In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
...
void ReadSLDump::atoms()
{
  ...
  // for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"after read atoms: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  ...
  // for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"after process atoms: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  ...
  //  for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"after map atoms: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  ...
  //  for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"one step before: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  migrate_atoms_by_coords();

    //  for (int i = 0; i < atom->nlocal; i++)
    //   if (atom->mask[i]) {
    //     if((atom->tag)[i]==9959) utils::logmesg(lmp,"one step after: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
    //   }
}
    ...
    if (replaceflag) {
      ...
      for (ifield = 1; ifield < nfield; ifield++) {
        ...
        case X:
          ...
          // if((atom->tag)[m]==9959) utils::logmesg(lmp,"READSLDUMP: Atom Local {}, Global {}, x is {}!\n",m,(atom->tag)[m],x[m][0]);
          break;
        case Y:
        ...
        case FX:
          ...
          // if((atom->tag)[m]==9959) utils::logmesg(lmp,"READSLDUMP: Atom Local {}, Global {}, fx is {}!\n",m,(atom->tag)[m],f[m][0]);
          break;
        case FY:
...
void ReadSLDump::migrate_atoms_by_coords()
{
  ...
  // for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"migrate debug 1: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  for (int i = 0; i < nlocal; i++) domain->remap(x[i],image[i]);

  // for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"migrate debug 2: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  ...
  // for (int i = 0; i < atom->nlocal; i++)
  //     if (atom->mask[i]) {
  //       if((atom->tag)[i]==9959) utils::logmesg(lmp,"migrate debug 3: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
  //     }
  auto irregular = new Irregular(lmp);
  irregular->migrate_atoms_super(1);
    // for (int i = 0; i < atom->nlocal; i++)
    //   if (atom->mask[i]) {
    //     if((atom->tag)[i]==9959) utils::logmesg(lmp,"migrate debug 4: In step {} atom index {} fx is {}, x is {:.31f}!\n",update->ntimestep,(atom->tag)[i],atom->f[i][0],atom->x[i][0]);
    //   }
  delete irregular;
