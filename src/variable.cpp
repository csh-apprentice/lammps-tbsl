                             ...
                             int &ntreestack, double *argstack, int &nargstack, int ivar)
{
  ...
  if (strcmp(word,"count") != 0 && strcmp(word,"mass")!=0 &&
      ...
      strcmp(word,"omega") != 0 && strcmp(word,"slradius") !=0 &&
      strcmp(word,"slradiusold") !=0 && strcmp(word,"slvradius") != 0 && 
      strcmp(word,"slcount")!=0  && strcmp(word,"slpB") != 0 && 
      strcmp(word,"slpBold") != 0 && strcmp(word,"slgastemp") !=0 && 
      strcmp(word,"slwalltemp") != 0 && strcmp(word,"sldelta")!=0 && 
      strcmp(word,"sldeltaold")!=0 && strcmp(word,"slvdelta") !=0 && 
      strcmp(word,"slnumatoms")!=0 && strcmp(word,"sldebug") !=0 && 
      strcmp(word,"slpb") != 0 && strcmp(word,"lostparticles")!=0 && 
      strcmp(word,"slsteps")!=0 && strcmp(word,"thradius")!=0 && 
      strcmp(word,"thvradius")!=0 && strcmp(word,"tharadius")!=0 && 
      strcmp(word,"thTb0")!=0 && strcmp(word,"thdelta")!=0)
    return 0;
  ...
  } else if (strcmp(word,"slradiusold") == 0) {
    if (narg == 2) value = group->SL_radius_old(igroup,slregion_function(args[1],ivar));
    else print_var_error(FLERR,group_errmesg,ivar);
  ...
  } else if (strcmp(word,"slpBold") == 0) {
    if (narg == 2) value = group->SL_pB_old(igroup,slregion_function(args[1],ivar));
    else print_var_error(FLERR,group_errmesg,ivar);
  ...
  }  else if (strcmp(word,"sldeltaold") == 0) {
    if (narg == 2) value = group->SL_delta_old(igroup,slregion_function(args[1],ivar));
    else print_var_error(FLERR,group_errmesg,ivar);
